...
<main role="main" id="main" class="col-lg-10">
            ...
            <div class="col-lg-8" >
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                        <a href="#" onclick="openModal(<?php echo $row['codCliente'] ?>)" data-target="#loadModal" data-toggle="modal"data-dismiss="modal" >Editar</a></td>
    ...
    <div class="loadModal" id="loadModal"></div>
</main>
